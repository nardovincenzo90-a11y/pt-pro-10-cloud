...
- Smart Coach visualizzato una sola volta e terminologia italiana (`Prontezza e fatica`, `Scarico consigliato`).
- Centro Nutrizione visualizzato una sola volta.
- Target macro collegati ai campi PostgreSQL reali `kcal_target`, `protein_g_target`, `carbs_g_target`, `fat_g_target`.
- Generatore nutrizione Cloud specializzato per giornata, settimana e mese.
- Salvataggio reale dei piani generati su `nutrition_days`, `meals` e `meal_items`.
- Pulizia di `undefined` e ID tecnici nella UI.
