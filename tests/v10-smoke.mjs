...
if(!index.includes('11.4.0-pro-school-academy'))throw new Error('PT-PRO 11.4.0 cache release missing');
...
if(!manifest.includes('11.4.0-PRO-SCHOOL-ACADEMY'))throw new Error('PT-PRO 11.4.0 release missing');
