...
if(!index.includes('11.5.2-pro-school-cloud-sync'))throw new Error('PT-PRO 11.5.2 cache release missing');
...
if(!manifest.includes('11.5.2-PRO-SCHOOL-CLOUD-SYNC'))throw new Error('PT-PRO 11.5.2 release missing');
