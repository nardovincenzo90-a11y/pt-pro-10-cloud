...
if(!index.includes('11.3.2-pro-direct-generation-school'))throw new Error('PT-PRO 11.3.2 cache release missing');
...
if(!manifest.includes('11.3.2-PRO-DIRECT-GENERATION-SCHOOL'))throw new Error('PT-PRO 11.3.2 release missing');
