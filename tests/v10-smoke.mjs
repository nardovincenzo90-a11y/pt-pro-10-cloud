...
if(!index.includes('11.8.1-pro-school-bulk-save')||!index.includes('/v10/quality-foundation.css'))throw new Error('PT-PRO 11.8.1 school bulk-save release missing');
...
if(!manifest.includes('11.8.1-PRO-SCHOOL-BULK-SAVE'))throw new Error('PT-PRO 11.8.1 release missing');
