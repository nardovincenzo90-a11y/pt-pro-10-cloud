...
const need=['index.html','app-manifest.js','auth-gate.js','v10/api.js','v10/nutrition-engine.js','v10/kernel.js','v10/wellness-engine.js','v10/sport-library.js','v10/wellness.js','v10/wellness-runtime.js','v10/admin-runtime.js','v10/school.js','v10/home.js','v10/workout.js','v10/progress.js','v10/nutrition.js','v10/more.js','v10/pro.js','v10/pro-advanced.js','v10/admin-pro.js','v10/coach-engine.js','v10/appearance-pro.js','v10/support.js','v10/final-runtime.js','v10/bootstrap.js','v10/styles.css','v10/features.css','v10/pro.css','v10/layout.css','supabase/PT-PRO_11_WELLNESS_SPORT_FOUNDATION.sql','supabase/PT-PRO_11_ADMIN_BOOTSTRAP.sql','supabase/PT-PRO_11_SECURITY_HARDENING.sql'];
...
for(const f of ['v10/api.js','v10/kernel.js','v10/wellness-engine.js','v10/sport-library.js','v10/wellness.js','v10/wellness-runtime.js','v10/admin-runtime.js','v10/school.js','v10/home.js','v10/workout.js','v10/progress.js','v10/nutrition.js','v10/coach-engine.js','v10/support.js','v10/bootstrap.js'])if(!manifest.includes(f))throw new Error(`Manifest missing ${f}`);
...
for(const token of ["['wellness','✨','Attività & Sport']","['onboarding','◎','Il mio percorso']","['school','🎓','Area Docenti']","['admin-users','♛','Utenti & Attività']","['guide','?','Guida & Tutorial']", "title!=='AMMINISTRAZIONE'||role==='admin'"])if(!kernel.includes(token))throw new Error(`Navigation missing ${token}`);
...
for(const token of ['football','basketball','volleyball','swimming','cycling','racket','combat','Tecnica di corsa','PTPROSportLibrary'])if(!sport.includes(token))throw new Error(`Sport library missing ${token}`);
...
for(const token of ["A.register('school'",'Area Docenti','I grado','II grado','Test atletici e motori','Scheda di valutazione','Giochi ludico-motori','Anatomia semplice','ptpro11_school_assessments'])if(!school.includes(token))throw new Error(`School missing ${token}`);
