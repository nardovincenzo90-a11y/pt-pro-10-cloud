...
if(!index.includes('11.8.0-pro-wellness-school-reliability')||!index.includes('/v10/quality-foundation.css'))throw new Error('PT-PRO 11.8.0 reliability release missing');
...
if(!manifest.includes('11.8.0-PRO-WELLNESS-SCHOOL-RELIABILITY'))throw new Error('PT-PRO 11.8.0 release missing');
