...
const need=['index.html','app-manifest.js','auth-gate.js','v10/api.js','v10/nutrition-engine.js','v10/kernel.js','v10/wellness-engine.js','v10/sport-library.js','v10/sport-library-walking.js','v10/wellness.js','v10/wellness-runtime.js','v10/admin-runtime.js','v10/school.js','v10/home.js','v10/workout.js','v10/progress.js','v10/nutrition.js','v10/more.js','v10/pro.js','v10/reports-sport-runtime.js','v10/pro-advanced.js','v10/admin-pro.js','v10/coach-engine.js','v10/coach-sport-runtime.js','v10/appearance-pro.js','v10/support.js','v10/final-runtime.js','v10/bootstrap.js','v10/styles.css','v10/features.css','v10/pro.css','v10/layout.css','supabase/PT-PRO_11_WELLNESS_SPORT_FOUNDATION.sql','supabase/PT-PRO_11_ADMIN_BOOTSTRAP.sql','supabase/PT-PRO_11_SECURITY_HARDENING.sql'];
...
if(!index.includes('11.1.0-wellness-school'))throw new Error('PT-PRO 11.1 cache release missing');
const manifest=fs.readFileSync('app-manifest.js','utf8');
for(const f of ['v10/api.js','v10/kernel.js','v10/wellness-engine.js','v10/sport-library.js','v10/sport-library-walking.js','v10/wellness.js','v10/wellness-runtime.js','v10/admin-runtime.js','v10/school.js','v10/home.js','v10/workout.js','v10/progress.js','v10/nutrition.js','v10/reports-sport-runtime.js','v10/coach-engine.js','v10/coach-sport-runtime.js','v10/support.js','v10/bootstrap.js'])if(!manifest.includes(f))throw new Error(`Manifest missing ${f}`);
if(!manifest.includes('11.1.0-WELLNESS-SCHOOL'))throw new Error('PT-PRO 11.1 release missing');
const kernel=fs.readFileSync('v10/kernel.js','utf8');
for(const token of ["['wellness','✨','Attività & Sport']","['onboarding','◎','Il mio percorso']","['school','🎓','Area Docenti']","['school','🎓','Scuola']","['admin-users','♛','Utenti & Attività']","['guide','?','Guida & Tutorial']", "title!=='AMMINISTRAZIONE'||role==='admin'"])if(!kernel.includes(token))throw new Error(`Navigation missing ${token}`);
...
console.log('PT-PRO 11.1 Wellness, Sport & School smoke: OK');