...
if(!index.includes('11.5.0-pro-teacher-planner'))throw new Error('PT-PRO 11.5.0 cache release missing');
...
if(!manifest.includes('11.5.0-PRO-TEACHER-PLANNER'))throw new Error('PT-PRO 11.5.0 release missing');
