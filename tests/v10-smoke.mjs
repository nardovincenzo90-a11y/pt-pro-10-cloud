...
if(!index.includes('11.7.1-pro-desktop-nav')||!index.includes('/v10/quality-foundation.css'))throw new Error('PT-PRO 11.7.1 desktop navigation release missing');
...
if(!manifest.includes('11.7.1-PRO-DESKTOP-NAV'))throw new Error('PT-PRO 11.7.1 release missing');
