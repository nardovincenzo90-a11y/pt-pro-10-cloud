...
if(!index.includes('11.3.1-pro-wellness-photo-guides'))throw new Error('PT-PRO 11.3.1 cache release missing');
...
if(!manifest.includes('11.3.1-PRO-WELLNESS-PHOTO-GUIDES'))throw new Error('PT-PRO 11.3.1 release missing');
