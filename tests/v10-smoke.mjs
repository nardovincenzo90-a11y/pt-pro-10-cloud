...
if(!index.includes('11.5.3-pro-school-sync-verify'))throw new Error('PT-PRO 11.5.3 cache release missing');
...
if(!manifest.includes('11.5.3-PRO-SCHOOL-SYNC-VERIFY'))throw new Error('PT-PRO 11.5.3 release missing');
