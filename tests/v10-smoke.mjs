...
if(!index.includes('11.5.1-pro-school-safe-save'))throw new Error('PT-PRO 11.5.1 cache release missing');
...
if(!manifest.includes('11.5.1-PRO-SCHOOL-SAFE-SAVE'))throw new Error('PT-PRO 11.5.1 release missing');
